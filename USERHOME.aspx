<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="USERHOME.aspx.cs" Inherits="SEEDLINK.USERHOME" %>
                ...
                <div class="container">
                    ...
                    <div class="navbar-collapse collapse">
                        ...
                        <li class="dropdown">
                            ...
                            <li>
                                <button id="btnCart" class ="btn btn-primary navbar-btn" type="button">CART 
                            ...
                            <li>
                                <div>
                                    ...
                                    <asp:Button ID="btnlogout" CssClass="btn btn-success navbar-btn" runat="server" Text="sign out" OnClick="btnlogout_Click"/>
                                    </div>
                            </li>
                            </ul>
                    </div>
